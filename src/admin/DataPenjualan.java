...
private  DefaultTableModel tabMode;
    ...
    public DataPenjualan() {
      ...
      Object[] Baris={"IDTransaksi","Tanggal","NamaBarang","Harga","Jumlah","Total"};
      tabMode = new DefaultTableModel(null,Baris);
      tabel.setModel(tabMode);
      String sql ="SELECT * FROM transaksi INNER JOIN detail";
      
      try{
          Statement stat = con.createStatement();
          ResultSet hasil = stat.executeQuery(sql);
          while(hasil.next()){
              String id = hasil.getString("transaksi.IDTransaksi");
              String tgl = hasil.getString("transaksi.Tanggal");
              String nama = hasil.getString("transaksi.NamaBarang");
              String harga = hasil.getString("transaksi.Harga");
              String jumlah = hasil.getString("transaksi.Jumlah");
              String total = hasil.getString("detail.Total");
              String [] data ={id,tgl,nama,harga,jumlah,total};
              tabMode.addRow(data);
          }
    ...
    private void cariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariActionPerformed
        if(mencari.getText().equals("")){
            ...
            try{
                ...
                ResultSet rs = stat.executeQuery("SELECT * FROM transaksi WHERE IDTransaksi like '%"+search+"%' OR Tanggal like '%"+search+"%' OR NamaBarang like '%"+search+"%'");
